...
func New() (e *Echo) {
	...
	//e.gorillaRouter = mux.NewRouter()

	e.routers = map[string]*Router{}
	//e.gorillaRouters = map[string]*mux.Router{}
...
func (e *Echo) add(host, method, path string, handler HandlerFunc, middleware ...MiddlewareFunc) *Route {
	...
	//e.gorillaRouter.NewRoute().Methods(method).Path(path).Name(name)
...
func (e *Echo) Start(address string) error {
	...
	//}
	//e.startupMutex.Unlock()
	return http.ListenAndServe(address, e) // e.Server.ListenAndServe() //e.Server.Serve(e.Listener)
}
...
func (e *Echo) StartTLS(address string, certFile, keyFile interface{}) (err error) {
	...
	//}
	//e.startupMutex.Unlock()
	return http.ListenAndServeTLS(address, cast.ToString(certFile), cast.ToString(keyFile), e) // s.ListenAndServeTLS(cast.ToString(certFile), cast.ToString(keyFile)) //s.Serve(e.TLSListener)
}
